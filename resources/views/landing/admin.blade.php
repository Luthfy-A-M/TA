              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Waiting Users</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$jumlahuserwaiting}}</div>
                      </div>
                      <div class="col-auto">
                        <i class="fas fa-fw fa-clock-o fa-2x text-primary"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$jumlahuseractive}}</div>
                      </div>
                      <div class="col-auto">
                        <i class="fas fa-fw fa-user-check fa-2x text-primary"></i>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">NonActive Users</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$jumlahusernonactive}}</div>
                      </div>
                      <div class="col-auto">
                        <i class="fas fa-fw fa-user-minus fa-2x text-primary"></i>
                      </div>
                    </div>
                  </div>
                </div>
