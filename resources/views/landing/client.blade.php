...
<head>
    ...
    <title>Client Landingpage</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="container post">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-0 post-body">
                ...
                <a class="btn btn-outline-primary px-4 py-3" href="/wizard">Create Strategy</a>
                <a class="btn btn-outline-success px-4 py-3" href="/strategylist">See Your Strategy List</a>
