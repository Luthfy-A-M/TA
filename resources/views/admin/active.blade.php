      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Facilitator - Aktif</h1>
          </div>
                        ...
                        <div class="row">
                          <div class="col-2 mx-1 my-1"> 
                            ...
                            <div class="dropdown-menu">                              
                              <a class="dropdown-item rejectEO" href="{{ url('/Admin/'. $user -> id . '/deactivate')}}">Deactivate Facilitator</a>                              
                              </form>
                            </div>
                          </div>
                        </div>
...
$(document).ready(function () {
  ...
  $('.rejectEO').on('click', function (e) {
    ...
    Swal.fire({
      title: 'Are You sure ?',
      text: "Deactivate this Facilitator ?.",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      ...
      if (result.value) {
        ...
        $.ajax({
            ...
            success: function(response) {
              Swal.fire('Rejected!', 'This Facilitator has been deactivated.', 'success').then(function(){
                location.reload();
              });
            },
